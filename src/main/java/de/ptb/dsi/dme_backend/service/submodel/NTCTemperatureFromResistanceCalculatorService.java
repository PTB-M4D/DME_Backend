...
@Service
public class NTCTemperatureFromResistanceCalculatorService implements ITemperatureFromResistanceCalculatorService {

    @Override
    public SiReal calculateTemperature(SiReal resistance) {

        // Calibration Factors
        double aNtc = 0.000928692;
        double bNtc = 0.000222219;
        double cNtc = 0.000000123621;

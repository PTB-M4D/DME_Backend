...
/**
 * <p>Java-Klasse für rectangularRegionType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="rectangularRegionType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "rectangularRegionType", namespace = "https://ptb.de/si", propOrder = {
    "covarianceMatrix",
    "coverageFactor",
    "coverageProbability",
    "distribution"
})
public class RectangularRegionType {
